    ...
    return (
        <div className="p-4 w-full">
            <div {...getRootProps()} className="w-full h-80 rounded-md cursor-pointer focus:outline-none">
                <input {...getInputProps()}/>
                <div className={"flex flex-col h-full space-y-3 border-2 border-slate-300 rounded-xl items-center justify-center"
                    ...
                    {isDragReject ? (
                        <p>Only pdfs are allowed</p> ) : (
                            <div>
                                ...
                                <p className="mt-2 text-base text-slate-500">Only .pdf extension will be accepted.</p>
                            </div>
                        )
                    }
                </div>
